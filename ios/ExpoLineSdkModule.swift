...
public class ExpoLineSdkModule: Module {
  ...
  public func definition() -> ModuleDefinition {
    ...
    AsyncFunction("logout") { (arguments: [String: Any]?, result: Promise) in
    ...
    AsyncFunction("getProfile") { (arguments: [String: Any]?, result: Promise) in
    ...
    AsyncFunction("refreshToken") { (arguments: [String: Any]?, result: Promise) in
    ...
    AsyncFunction("verifyAccessToken") { (arguments: [String: Any]?, result: Promise) in
    ...
    AsyncFunction("getBotFriendshipStatus") { (arguments: [String: Any]?, result: Promise) in
    ...
    AsyncFunction("currentAccessToken") { (arguments: [String: Any]?, result: Promise) in
